...
export const experienceItems = [
    { time: 'Jul 2023 - Sept 2023', company: 'Dell Technologies',  role: 'Software Engineer Intern', 
    description: 'Created a dashboard using Angular to find orders (order tracker) with missing details to proactively fix asset creation.Developed a scheduled email sender service (cron job) using Java Spring boot that gets data from an Oracle sql database and sends automated emails with weekly diagnostic reports.Improved server query time for the dashboard by 50% for missing ship date by optimizing SQL queries', 
